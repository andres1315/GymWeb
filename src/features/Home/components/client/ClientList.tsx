            ...
            <div className="space-y-1 h-full overflow-y-auto">
                {filteredPlans.map((plan, index) => {
                    ...
                    return (
                        <Card
                            key={plan.id}
                            className={`cursor-pointer transition-all duration-500 scale-95 hover:scale-100 backdrop-blur-sm border-white/10 ${selectedPlan.id === plan.id
                        ...
                        >
                            <CardContent className="p-4">
                                ...
                                <div className="flex items-center justify-between text-xs">
                                    ...
                                    <div
                                        className={`flex items-center space-x-1 ${plan.growth > 0 ? "text-emerald-400" : "text-red-400"
                                            }`}
                                    >
